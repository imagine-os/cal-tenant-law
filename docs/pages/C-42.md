...
2. **VideoPlayer** — the embed, a labelled progress bar, and the 10-foot control row: Back 10s · **Play** · Forward 10s · Previous · Next lesson · Mark as watched. An article lesson shows the reading card instead (`DocPreview`, the reading time and the link to the firm's page).
...
- `RULE-LEARN-05` — no autoplay with sound: `autoplay=0`, youtube-nocookie.com, no third-party script loaded.
...
- The embed is `https://www.youtube-nocookie.com/embed/<id>?enablejsapi=1&origin=<origin>&rel=0&modestbranding=1&playsinline=1&autoplay=0&cc_load_policy=1`.
