...
Access (D-048, 2026-09-20): `super_admin`, `owner`, `attorney` and `paralegal` (was every staff role). Front desk and marketing never see legal memory or the law-change log.
