...
status: superseded
module: client (removed; see C-20)
---

> **Superseded by C-20 (2026-09-20).** The binder at `/app/binder` now belongs to the binder module
> (`docs/pages/C-20.md`): evidence the client uploads or imports, exhibits, the objects map at `/app/binder/map`,
> and the staff side at L-31. The route and spec described below were removed from `src/modules/client` in the
> same commit; this page is kept for history.
