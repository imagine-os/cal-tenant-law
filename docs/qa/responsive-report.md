...
generated: 2026-09-18T21:00:32.179Z
routes: 49
...
| `D-21` | target-size | warn | target 21x9 px is under 24 px | `div.cv-frame > div.cv-frame-head > span.cv-frame-btns > button.btn.btn-outline` | 180 |
| `D-21` | target-size | warn | target 22x9 px is under 24 px | `div.cv-frame > div.cv-frame-head > span.cv-frame-btns > button.btn.btn-ghost` | 180 |
| `D-21` | target-size | warn | target 23x10 px is under 24 px | `div.cv-frame > div.cv-frame-head > span.cv-frame-btns > button.btn.btn-outline` | 90 |
| `D-21` | target-size | warn | target 24x10 px is under 24 px | `div.cv-frame > div.cv-frame-head > span.cv-frame-btns > button.btn.btn-ghost` | 90 |
| `D-21` | target-size | warn | target 26x12 px is under 24 px | `div.cv-frame > div.cv-frame-head > span.cv-frame-btns > button.btn.btn-outline` | 90 |
| `D-21` | target-size | warn | target 28x12 px is under 24 px | `div.cv-frame > div.cv-frame-head > span.cv-frame-btns > button.btn.btn-ghost` | 90 |
| `D-21` | target-size | warn | target 31x16 px is under 24 px | `div.cv-frame > div.cv-frame-head > span.cv-frame-btns > button.btn.btn-outline` | 90 |
| `D-21` | target-size | warn | target 34x16 px is under 24 px | `div.cv-frame > div.cv-frame-head > span.cv-frame-btns > button.btn.btn-ghost` | 90 |
