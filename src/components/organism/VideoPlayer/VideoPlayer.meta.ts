...
export default defineMeta({
  ...
  props: [
    ...
    { name: 'posterSrc', type: 'string | null', description: 'Poster shown before Play (the lesson thumbnail); a drawn poster with the title stands in when absent or broken' },
  ...
  states: ['poster (initial - nothing loaded, never autoplays)', 'paused', 'playing', 'resumed part way', 'ended (writes 100%)', 'with the page\'s Previous / Next buttons', '10-foot control row at >= 1920', 'dark theme'],
  usages: [
