 ...
 * routes with `nav`. The screen background follows the route's `spec.tone` (home / list / form). Hides the hub link
 * when it runs inside a PhoneFrame / DeviceFrame iframe.
 */
