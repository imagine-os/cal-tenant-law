...
export default defineMeta({
  ...
  usages: [{ title: 'Frame with placeholder content', render: () => h('div', { style: { border: '1px solid var(--color-border)', borderRadius: 10, overflow: 'hidden' } }, h(SiteLayout, null, h('div', { className: 'container', style: { padding: '48px 16px' } }, h('h1', null, 'Your cloudy day is about to clear up.')))) }],
