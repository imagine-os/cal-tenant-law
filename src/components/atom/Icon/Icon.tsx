...
/**
 * Icon atom: one inline-SVG registry of 24-box outline glyphs (Lucide weight, 1.5 px default stroke), no dependency.
 * Multi-command paths are joined with `M` so every icon is a single <path>. Adding an icon = one line here; it shows in
 * D-02 automatically. Names are stable vocabulary for `nav.icon`, `Button icon`, `EmptyState icon`.
 */
export const ICONS = {
  home: 'M3 11l9-8 9 8v9a2 2 0 0 1-2 2h-4v-6H9v6H5a2 2 0 0 1-2-2z',
  gavel: 'M14 4l6 6M8 10l6-6M3 21l7-7M12 8l4 4-6 6-4-4zM15 13l6 6',
  scale: 'M12 3v18M4 21h16M6 7h12M6 7l-3 7a3 3 0 0 0 6 0zM18 7l-3 7a3 3 0 0 0 6 0z',
  'file-text': 'M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8zM14 2v6h6M16 13H8M16 17H8M10 9H8',
  briefcase: 'M4 7h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2zM8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2M2 13h20',
  calendar: 'M8 2v4M16 2v4M3 9h18M5 4h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z',
  clock: 'M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20zM12 6v6l4 2',
  timeline: 'M3 12h18M7 12V7M12 12v-3M17 12V5M7 12a2 2 0 1 0 0 .1M12 12a2 2 0 1 0 0 .1M17 12a2 2 0 1 0 0 .1',
  ...
  kanban: 'M4 3h4a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1zM14 3h4a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1z',
  list: 'M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01',
  grid: 'M3 3h7v7H3zM14 3h7v7h-7zM14 14h7v7h-7zM3 14h7v7H3z',
  table: 'M3 3h18v18H3zM3 9h18M3 15h18M9 3v18M15 3v18',
  zoom: 'M11 19a8 8 0 1 0 0-16 8 8 0 0 0 0 16zM21 21l-4.35-4.35M11 8v6M8 11h6',
  search: 'M11 19a8 8 0 1 0 0-16 8 8 0 0 0 0 16zM21 21l-4.35-4.35',
  cpu: 'M5 5h14a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1zM9 9h6v6H9zM9 1v3M15 1v3M9 20v3M15 20v3M20 9h3M20 14h3M1 9h3M1 14h3',
  sparkles: 'M12 3l1.8 5.2L19 10l-5.2 1.8L12 17l-1.8-5.2L5 10l5.2-1.8zM5 19l.7 1.8L7.5 21.5l-1.8.7L5 24l-.7-1.8-1.8-.7 1.8-.7zM19 2l.6 1.4L21 4l-1.4.6L19 6l-.6-1.4L17 4l1.4-.6z',
  ...
  key: 'M21 2l-2 2M15.5 7.5l3-3M7 21a5 5 0 1 0 0-10 5 5 0 0 0 0 10zM10.5 12.5L19 4',
  ...
  spec: 'M9 3h6l2 2h3a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h3zM9 3v3h6V3M8 12h8M8 16h5',
  ...
  palette: 'M12 22a10 10 0 1 1 10-10c0 2-1.5 3-3 3h-2a2 2 0 0 0-1.5 3.3c.4.5.5 1 .5 1.7 0 1-1 2-2 2zM7.5 11a1 1 0 1 0 0-.1M12 7.5a1 1 0 1 0 0-.1M16.5 11a1 1 0 1 0 0-.1',
  megaphone: 'M3 11l18-7v16l-18-7v-2zM7 13v5a2 2 0 0 0 4 0v-3',
  gamepad: 'M6 12h4M8 10v4M15 13h.01M18 11h.01M17.3 5H6.7a4 4 0 0 0-4 3.6L2 17a2.5 2.5 0 0 0 4.4 1.6L8.5 16h7l2.1 2.6A2.5 2.5 0 0 0 22 17l-.7-8.4a4 4 0 0 0-4-3.6z',
  feedback: 'M21 11.5a8.4 8.4 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.4 8.4 0 0 1-3.8-.9L3 21l1.9-5.7a8.4 8.4 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.4 8.4 0 0 1 3.8-.9h.5a8.5 8.5 0 0 1 8 8v.5zM12 8v4M12 15h.01',
  pin: 'M12 17v5M9 11V5a3 3 0 0 1 6 0v6l2 2v2H7v-2z',
  ...
  tv: 'M2 7h20a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1zM17 2l-5 5-5-5',
  smartphone: 'M7 2h10a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2zM12 18h.01',
  tablet: 'M5 2h14a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2zM12 18h.01',
  monitor: 'M2 3h20a1 1 0 0 1 1 1v11a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1zM8 21h8M12 16v5',
...
/** Default stroke 1.5; nav / header glyphs pass 2 at larger sizes. Unknown names render the question mark so a typo is visible, never blank. */
