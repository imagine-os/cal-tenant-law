...
import { landingSpec, attorneysSpec, videosSpec, proposalSpec, replacesSpec, roadmapSpec } from './specs';
...
export const routes: RouteDef[] = [
  ...
  { ...base, path: '/site/attorneys', element: h(AttorneysPage), spec: attorneysSpec },
  { ...base, path: '/site/videos', element: h(VideosPage), spec: videosSpec },
