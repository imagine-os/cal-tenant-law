...
export const FEATURES: Feature[] = [
  ...
  { id: 'store', department: 'finance', roles: ['marketing', 'client'], codes: ['P-10', 'P-11', 'P-12'], label: { en: 'Services menu by board stage', es: 'Menú de servicios por etapa' }, what: { en: 'The firm\u2019s whole menu \u2014 every SKU-numbered document, kit and consultation \u2014 filed under the eviction stage it belongs to, with a page per service and the funnel explained. Built; prices show as listed until the firm confirms them.', es: 'Todo el men\u00fa del bufete \u2014 cada documento, kit y consulta con SKU \u2014 archivado en la etapa del desalojo que le corresponde, con una p\u00e1gina por servicio y el embudo explicado.' } },
